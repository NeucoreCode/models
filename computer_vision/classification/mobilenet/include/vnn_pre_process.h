...
vsi_status vnn_PreProcessMobilenet(vsi_nn_graph_t *graph, const char *image_name);
vsi_status vnn_PreProcessMobilenet_ImageProcess(vsi_nn_graph_t *graph, const char *image_name);
