...
vsi_status vnn_PreProcessInceptionv3(vsi_nn_graph_t *graph, const char *image_name);
vsi_status vnn_PreProcessInceptionv3_ImageProcess(vsi_nn_graph_t *graph, const char *image_name);
