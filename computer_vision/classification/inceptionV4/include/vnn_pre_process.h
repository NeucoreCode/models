...
vsi_status vnn_PreProcessInceptionv4(vsi_nn_graph_t *graph, const char *image_name);
vsi_status vnn_PreProcessInceptionv4_ImageProcess(vsi_nn_graph_t *graph, const char *image_name);
