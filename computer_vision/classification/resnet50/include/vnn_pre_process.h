...
vsi_status vnn_PreProcessResnet50Caffe(vsi_nn_graph_t *graph, const char *image_name);
vsi_status vnn_PreProcessResnet50Caffe_ImageProcess(vsi_nn_graph_t *graph, const char *image_name);
