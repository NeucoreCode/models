...
vsi_status vnn_PreProcessAlexnetCaffe(vsi_nn_graph_t *graph, const char *image_name);
vsi_status vnn_PreProcessAlexnetCaffe_ImageProcess(vsi_nn_graph_t *graph, const char *image_name);
